const { applyAreaRuby } = require('./areaRuby');
...
function toUnityDisplayText(value) {
  return toFullwidthDigits(applyAreaRuby(value));
}

module.exports = { toFullwidthDigits, toUnityDisplayText };
